...
import { net } from "./net";
import { CA_API_VERSION, DMESDKConfiguration, FileMeta, isSessionValid, Session } from "./sdk";
...
const pushDataToPostbox = async (
    ...
    const url: string = `https://api.${options.domain}/${CA_API_VERSION}/permission-access/postbox/${postboxId}`;
